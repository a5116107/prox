...
func Register(c *gin.Context) {
	if operation_setting.GetCommunityGateSetting().Enabled && operation_setting.GetCommunityGateSetting().DisablePasswordRegister {
		common.ApiErrorMsg(c, "本站已开启社区准入：请使用 dc.hhhl.cc 社区授权登录注册。")
		return
	}
