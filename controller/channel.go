...
// UpdateChannelStatus updates only status and the derived ability/cache state.
// The dedicated route also keeps older admin bundles working across releases.
func UpdateChannelStatus(c *gin.Context) {
	...
	if previousStatus != request.Status {
		...
		statusInfo := channel.GetOtherInfo()
		statusInfo["status_reason"] = "manual admin status update"
		statusInfo["status_time"] = common.GetTimestamp()
		channel.SetOtherInfo(statusInfo)
