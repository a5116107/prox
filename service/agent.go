...
func agentSettingPublicMap() map[string]any {
	...
	return map[string]any{
		...
		"image_generation_enabled":          cfg.ImageGenerationEnabled,
		"image_api_base_url":                cfg.ImageAPIBaseURL,
		"image_api_key_configured":          strings.TrimSpace(cfg.ImageAPIKey) != "",
		"image_model":                       cfg.ImageModel,
		"image_size":                        cfg.ImageSize,
		"image_timeout_seconds":             cfg.ImageTimeoutSeconds,
		"image_retry_limit":                 cfg.ImageRetryLimit,
		"image_retry_base_delay_seconds":    cfg.ImageRetryBaseDelaySeconds,
		"image_retry_max_delay_seconds":     cfg.ImageRetryMaxDelaySeconds,
		"image_cooldown_seconds":            cfg.ImageCooldownSeconds,
		"image_require_bind":                cfg.ImageRequireBind,
