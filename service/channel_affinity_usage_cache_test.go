...
func newChannelAffinityStatsTestKeys(t *testing.T) (string, string) {
	t.Helper()
	sequence := channelAffinityStatsTestSequence.Add(1)
	return fmt.Sprintf("%s_rule_%d", t.Name(), sequence),
		fmt.Sprintf("%s_fp_%d", t.Name(), sequence)
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName, keyFP := newChannelAffinityStatsTestKeys(t)
	usingGroup := "default"
