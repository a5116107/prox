...
const OperationSetting = () => {
  ...
  const getOptions = async () => {
    ...
    if (success) {
      ...
      newInputs['checkin_setting.jump_mode'] =
        newInputs['checkin_setting.jump_mode'] === 'api' ? 'api' : 'direct';
      newInputs['checkin_setting.community_checkin_url'] =
        newInputs['checkin_setting.community_checkin_url'] || '';
      newInputs['checkin_setting.qq_checkin_url'] =
        newInputs['checkin_setting.qq_checkin_url'] || '';
      newInputs['checkin_setting.tg_checkin_url'] =
        newInputs['checkin_setting.tg_checkin_url'] || '';
