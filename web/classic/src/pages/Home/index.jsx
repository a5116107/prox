...
const normalizeAnnouncementBoolean = (value) =>
  value === true || value === 'true' || value === 1 || value === '1';

const hasForcePopupAnnouncement = (announcements = []) =>
  Array.isArray(announcements) &&
  announcements.some(
    (item) =>
      normalizeAnnouncementBoolean(item?.forcePopup) ||
      normalizeAnnouncementBoolean(item?.force_popup) ||
      normalizeAnnouncementBoolean(item?.forced),
  );
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    if (hasForcePopupAnnouncement(announcements)) return;
