...
import { AgentOpsSection } from './agent-ops-section'
import { CommunityOpsSection } from './community-ops-section'
import { MembershipRiskSection } from './membership-risk-section'
import { QuizBankSection } from './quiz-bank-section'
import { RiskControlSection } from './risk-control-section'

const OPERATIONS_SECTION_ALIASES = {
  'account-risk-control': 'risk-control',
  'account-risk': 'risk-control',
} as const
...
const OPERATIONS_SECTIONS = [
  ...
  {
    id: 'community-ops',
    titleKey: 'Community Operations Manager',
    build: (settings: OperationsSettings) => (
      <CommunityOpsSection defaultValues={settings} />
    ),
  },
  {
    id: 'risk-control',
    ...
    build: (settings: OperationsSettings) => (
      <RiskControlSection
        defaultValues={settings as Record<string, boolean | number | string>}
      />
    ),
  },
  {
    id: 'membership-risk',
    titleKey: 'Membership Risk',
    build: (settings: OperationsSettings) => (
      <MembershipRiskSection defaultValues={settings} />
    ),
  },
  {
    id: 'agent-ops',
    titleKey: 'Agent Operations Center',
    build: (settings: OperationsSettings) => (
      <AgentOpsSection defaultValues={settings} />
    ),
  },
  {
    id: 'quiz-banks',
    titleKey: 'Quiz bank management',
    build: (settings: OperationsSettings) => (
      <QuizBankSection defaultValues={settings} />
    ),
  },
  {
    id: 'monitoring',
...
export type OperationsSectionId =
  ...
  | keyof typeof OPERATIONS_SECTION_ALIASES
...
>({
  ...
  aliases: OPERATIONS_SECTION_ALIASES,
