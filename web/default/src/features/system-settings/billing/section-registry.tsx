    ...
    build: (settings: BillingSettings) => (
      <CheckinSettingsSection
        defaultValues={{
          ...
          jumpMode: settings['checkin_setting.jump_mode'],
          communityCheckinUrl:
            settings['checkin_setting.community_checkin_url'],
          qqCheckinUrl: settings['checkin_setting.qq_checkin_url'],
          tgCheckinUrl: settings['checkin_setting.tg_checkin_url'],
        }}
      />
    ),
  },
