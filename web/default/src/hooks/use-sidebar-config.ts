...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  // Game admin is now a standalone external panel; leave unmapped to avoid
  // conflicting with the separate /game-admin service.
  '/api/agent/chatops/bind-page': { section: 'admin', module: 'chatBinding' },
}
